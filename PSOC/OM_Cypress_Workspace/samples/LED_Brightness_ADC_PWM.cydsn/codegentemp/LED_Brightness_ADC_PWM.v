// ======================================================================
// LED_Brightness_ADC_PWM.v generated from TopDesign.cysch
// 11/01/2021 at 13:19
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("98e848e7-ece5-4902-8b81-9bb4fdba9037/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("98e848e7-ece5-4902-8b81-9bb4fdba9037/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("bdb66ea8-ffa7-42b0-ace6-4fab3a5cf93b"),
		  .source_clock_id(""),
		  .divisor(0),
